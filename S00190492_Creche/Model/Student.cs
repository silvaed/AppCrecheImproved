...
namespace S00190492_Creche.Model
{
    public class Student
    {
        ...
        //public string[] Hours { get; set; } = { "Full Time", "Part Time" };
        //[Required(ErrorMessage = "Select at least one day of week")]
        //[Display(Name = "Days of Week")]
        //public string[] DaysRequested { get; set; } = { "Monday", "Tuesday", "Wednesday", "Thursday", "Friday" };
